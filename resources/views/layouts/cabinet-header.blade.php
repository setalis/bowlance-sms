<div class="bg-base-100 border-base-content/20 lg:ps-75 sticky top-0 z-50 flex border-b">
    <div class="mx-auto w-full max-w-7xl flex items-center">
        <div class="flex items-center justify-between">
            <a href="{{ route('home') }}" class="text-2xl font-bold" target="_blank">
                    ...
                    <ul class="dropdown-menu dropdown-open:opacity-100 max-w-75 hidden w-full space-y-0.5" role="menu"
                        ...
                        <li class="dropdown-header pt-4.5 mb-1 gap-4 px-5 pb-3.5">
                            ...
                            <div>
                                ...
                                <p class="text-base-content/80 font-medium">{{ auth()->user()->phone ?? auth()->user()->email }}</p>
                            </div>
                        </li>
                        <li>
                            <a class="dropdown-item px-3" href="{{ route('cabinet.profile.edit') }}">
                                <span class="icon-[tabler--user] size-5"></span>
                                Редактировать профиль
                            </a>
                        </li>
                        <li class="dropdown-footer p-2 pt-1">
                            <form method="POST" action="{{ route('cabinet.logout') }}" class="w-full">
                                @csrf
                                <button type="submit"
