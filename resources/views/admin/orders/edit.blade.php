                    ...
                    <div class="card-body">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div class="flex gap-4">
                                    <label class="flex items-center gap-2 cursor-pointer">
                                        <input type="radio" 
                                               ...
                                               {{ old('delivery_type', $order->delivery_type?->value ?? 'delivery') === 'delivery' ? 'checked' : '' }}>
                                        <span>Доставка</span>
                                    </label>
                                    <label class="flex items-center gap-2 cursor-pointer">
                                        <input type="radio" 
                            ...
                            <div>
                                ...
                                <input type="text" name="promo_code" value="{{ old('promo_code', $order->promo_code) }}"
...
function orderForm() {
    ...
    return {
        ...
        deliveryType: '{{ old('delivery_type', $order->delivery_type?->value ?? 'delivery') }}',
