                    ...
                    <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                        ...
                        <div>
                            ...
                            <select name="type"
                                    ...
                                    required>
                                <option value="percent" {{ old('type', $discount->type->value) === 'percent' ? 'selected' : '' }}>Процент</option>
                                <option value="amount" {{ old('type', $discount->type->value) === 'amount' ? 'selected' : '' }}>Сумма (₾)</option>
                            </select>
                            @error('type')
                                <span class="text-error text-sm mt-1 block">{{ $message }}</span>
                            @enderror
