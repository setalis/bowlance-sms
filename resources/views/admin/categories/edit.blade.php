...
@section('content')
    <div class="space-y-6">
        ...
        <div class="bg-base-100 shadow-base-300/20 w-full space-y-6 rounded-xl p-6 shadow-md lg:p-8">
            <div>
                <h3 class="text-base-content mb-1.5 text-2xl font-semibold">Редактировать категорию</h3>
                        ...
                        <div class="space-y-3 rounded-lg bg-base-200/50 p-4">
                            ...
                            <div>
                                ...
                                <textarea name="description_ru" 
                                          ...
                                          id="description_ru" 
                                          rows="3">{{ old('description_ru', $category->description_ru ?? $category->getRawOriginal('description')) }}</textarea>
                        ...
                        <div class="space-y-3 rounded-lg bg-base-200/50 p-4">
                            ...
                            <div>
                                ...
                                <textarea name="description_ka" 
                                          ...
                                          id="description_ka" 
                                          rows="3">{{ old('description_ka', $category->description_ka) }}</textarea>
                ...
                <div class="space-y-4 border-t border-base-content/10 pt-6">
                    ...
                    <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                        ...
                        <div>
                            ...
                            <input type="text" 
                                   ...
                                   id="meta_type" 
                                   value="{{ old('meta_type', $category->meta_type) }}" />
                            @error('meta_type')
                                <span class="text-error text-sm mt-1 block">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div>
                        ...
                        <input type="text" 
                               ...
                               id="meta_image" 
                               value="{{ old('meta_image', $category->meta_image) }}" />
                        @error('meta_image')
                            <span class="text-error text-sm mt-1 block">{{ $message }}</span>
                        @enderror
                    </div>
