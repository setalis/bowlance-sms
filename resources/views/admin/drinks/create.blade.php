...
@section('content')
    <div class="space-y-6">
        ...
        <div class="bg-base-100 shadow-base-300/20 w-full space-y-6 rounded-xl p-6 shadow-md lg:p-8">
            <div>
                <h3 class="text-base-content mb-1.5 text-2xl font-semibold">Создать напиток</h3>
                <p class="text-base-content/80">Добавьте новый напиток в меню</p>
            </div>

            <form action="{{ route('admin.drinks.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                @csrf
