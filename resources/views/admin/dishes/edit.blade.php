...
@section('content')
    <div class="space-y-6">
        ...
        <div class="bg-base-100 shadow-base-300/20 w-full space-y-6 rounded-xl p-6 shadow-md lg:p-8">
            <div>
                <h3 class="text-base-content mb-1.5 text-2xl font-semibold">Редактировать блюдо</h3>
                <p class="text-base-content/80">Обновите информацию о блюде</p>
            </div>
            ...
            <form action="{{ route('admin.dishes.update', $dish) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                        ...
                        <div class="space-y-3 rounded-lg bg-base-200/50 p-4">
                            ...
                            <div>
                                ...
                                <input type="text" 
                                       ...
                                       id="name_ru" 
                                       value="{{ old('name_ru', $dish->name_ru ?? $dish->getRawOriginal('name')) }}" 
                                       required />
                                @error('name_ru')
                                    <span class="text-error text-sm mt-1 block">{{ $message }}</span>
                                @enderror
                            ...
                            <div>
                                ...
                                <textarea name="description_ru" 
                                          ...
                                          id="description_ru" 
                                          rows="4">{{ old('description_ru', $dish->description_ru ?? $dish->getRawOriginal('description')) }}</textarea>
                        ...
                        <div class="space-y-3 rounded-lg bg-base-200/50 p-4">
                            ...
                            <div>
                                ...
                                <input type="text" 
                                       ...
                                       id="name_ka" 
                                       value="{{ old('name_ka', $dish->name_ka) }}" />
                                @error('name_ka')
                                    <span class="text-error text-sm mt-1 block">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div>
                                ...
                                <textarea name="description_ka" 
                                          ...
                                          id="description_ka" 
                                          rows="4">{{ old('description_ka', $dish->description_ka) }}</textarea>
                ...
                <div class="space-y-4 border-t border-base-content/10 pt-6">
                    ...
                    <div>
                        <label class="label-text" for="poster_product_id">Poster Product ID</label>
                        <input type="number"
                               name="poster_product_id"
                               placeholder="ID товара в Poster"
                               class="input @error('poster_product_id') input-error @enderror"
                               id="poster_product_id"
                               value="{{ old('poster_product_id', $dish->poster_product_id) }}"
                               min="1" />
                        @error('poster_product_id')
                            <span class="text-error text-sm mt-1 block">{{ $message }}</span>
                        @enderror
                    </div>
                </div>
